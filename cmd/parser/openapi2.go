...
import (
	...
	openapi2 "github.com/arthurbcp/kuma-cli/pkg/openapi/v2"
	"github.com/spf13/afero"
	"github.com/spf13/cobra"
)

// OpenAPI2ParserCmd represents the 'openapi' parser subcommand.
var OpenAPI2ParserCmd = &cobra.Command{
	Use:   "openapi2",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		config, err := parseOpenAPI2(ParserFilePath)
		if err != nil {
...
func parseOpenAPI2(file string) (map[string]interface{}, error) {
	helpers := helpers.NewHelpers()
	...
	fileStruct := openapi2.ParseToOpenAPITemplate(fileData)
